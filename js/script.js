$(document).ready(function() {
  ...
  function generateTiles() {
    ...
    // Remove existing .tile-words elements
    $('.tile-words').remove();

    // Create new .tile-words element
    var tileWords = $('<div class="tile-words"></div>');
    $('body').append(tileWords);
    ...
    words.forEach(function(word, index){
      ...
      tileWords.append(tile);

      // Set font size based on slider value
      tile.css('font-size', fontSizeSlider.val() + 'px');

      // Make each tile clickable to fade out and remove it
      tile.click(function() {
        // Play sound effect
        sound.play();
